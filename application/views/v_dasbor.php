...
<div class="page-content fade-in-up">
    ...
    <!-- LAPORAN PENDAPATAN RINCI -->
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">
                        <i class="fa fa-bar-chart"></i> Laporan Pendapatan Rinci
                    </div>
                    <div class="ibox-tools">
                        <select id="filterTahun" class="form-control form-control-sm" style="width: 150px;">
                ...
                <div class="ibox-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="tabelPendapatan">
                            ...
                            <tfoot class="thead-light">
                                <tr>
                                    ...
                                    <th class="text-center" id="totalTransaksi">-</th>
                                    <th class="text-center" id="rataRata">-</th>
                                    <th></th>
                                </tr>
                            </tfoot>
                        </table>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    <div class="ibox-title" style="color: white;">
                        <i class="fa fa-exclamation-triangle"></i> Laporan Piutang Penghuni
                    </div>
                </div>
                <div class="ibox-body">
                    <?php if ($statistik_piutang && $statistik_piutang->total_penghuni_hutang > 0): ?>
                    <!-- STATISTIK PIUTANG -->
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="card border-warning">
                                <div class="card-body text-center">
                                    <h4 class="text-warning"><?= $statistik_piutang->total_penghuni_hutang ?></h4>
                                    <small class="text-muted">Penghuni Berhutang</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card border-danger">
                                <div class="card-body text-center">
                                    <h5 class="text-danger">Rp<?= number_format($statistik_piutang->total_piutang, 0, ',', '.') ?></h5>
                        ...
                        <div class="col-md-3">
                            <div class="card border-info">
                                <div class="card-body text-center">
                                    <h5 class="text-info">Rp<?= number_format($statistik_piutang->rata_piutang, 0, ',', '.') ?></h5>
                                    <small class="text-muted">Rata-rata Piutang</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card border-primary">
                                <div class="card-body text-center">
                                    <h5 class="text-primary">Rp<?= number_format($statistik_piutang->piutang_tertinggi, 0, ',', '.') ?></h5>
                                    <small class="text-muted">Piutang Tertinggi</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="text-center">Lama Huni</th>
                            ...
                            <tbody>
                                <?php 
                                $no = 1; 
                                foreach ($detail_piutang as $piutang): 
                                    $tgl_masuk = DateTime::createFromFormat('d-m-Y', $piutang->tgl_masuk);
                                    $now = new DateTime();
                                    $interval = $tgl_masuk->diff($now);
                                    $lama_huni = $interval->y * 12 + $interval->m;
                                    
                                    $persentase_bayar = $piutang->tagihan > 0 ? ($piutang->bayar / $piutang->tagihan * 100) : 0;
                                ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td class="text-center"><strong><?= $piutang->no_kamar ?></strong></td>
                                    <td><?= $piutang->nama ?></td>
                                    <td class="text-right">Rp<?= number_format($piutang->tagihan, 0, ',', '.') ?></td>
                                    <td class="text-right text-success">Rp<?= number_format($piutang->bayar, 0, ',', '.') ?></td>
                                    <td class="text-right">
                                        <strong class="text-danger">Rp<?= number_format($piutang->piutang, 0, ',', '.') ?></strong>
                                    </td>
                                    <td class="text-center"><?= $lama_huni ?> bulan</td>
                                    <td class="text-center">
                                        <?php if ($persentase_bayar < 30): ?>
                                            <span class="badge badge-danger">Kritis</span>
                                        <?php elseif ($persentase_bayar < 70): ?>
                    ...
                    <div class="alert alert-success text-center">
                        ...
                        <p class="mb-0">Semua penghuni telah melunasi pembayaran mereka.</p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
